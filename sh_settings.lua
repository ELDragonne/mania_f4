...
Mania.f4.language = {
	...
	--> Commands
	changeName = 'Changer son Nom',
	requestLicense = '',
	changeJob = 'Changer le Nom de Job',
	dropWeapon = 'Donner sont arme',
	sellAllDoors = 'Vendre ça porte',
	...
	--> Other
	nothing = 'Il est actuellement indisponible...'
}
